...
local redzlib = {
	Themes = {
		CyberNeon = {
			-- Gradiente cyberpunk roxo/cyan
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(15, 5, 30)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(80, 20, 120)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 200, 255))
			}),
			["Color Hub 2"] = Color3.fromRGB(18, 10, 35), -- Fundo escuro roxo
			["Color Stroke"] = Color3.fromRGB(0, 180, 240), -- Cyan neon
			["Color Theme"] = Color3.fromRGB(180, 0, 255), -- Roxo vibrante
			["Color Text"] = Color3.fromRGB(230, 240, 255), -- Texto claro azulado
			["Color Dark Text"] = Color3.fromRGB(140, 160, 200) -- Texto secundário
		},
		OceanDream = {
			...
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 200, 180))
			}),
			["Color Hub 2"] = Color3.fromRGB(8, 18, 30),
			["Color Stroke"] = Color3.fromRGB(0, 220, 200),
			["Color Theme"] = Color3.fromRGB(0, 180, 255),
			["Color Text"] = Color3.fromRGB(220, 245, 255),
			["Color Dark Text"] = Color3.fromRGB(120, 160, 180)
		},
		SunsetVibe = {
			-- Tema pôr do sol
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(20, 10, 30)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(180, 60, 80)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 150, 50))
			}),
			["Color Hub 2"] = Color3.fromRGB(25, 15, 20),
			["Color Stroke"] = Color3.fromRGB(255, 100, 60),
			["Color Theme"] = Color3.fromRGB(255, 140, 0),
			["Color Text"] = Color3.fromRGB(255, 240, 230),
			["Color Dark Text"] = Color3.fromRGB(200, 150, 140)
		},
		NeonGreen = {
			-- Tema Matrix/verde neon
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(5, 15, 5)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(20, 80, 20)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 255, 100))
			}),
			["Color Hub 2"] = Color3.fromRGB(8, 20, 8),
			["Color Stroke"] = Color3.fromRGB(0, 255, 120),
			["Color Theme"] = Color3.fromRGB(50, 255, 100),
			["Color Text"] = Color3.fromRGB(200, 255, 220),
			["Color Dark Text"] = Color3.fromRGB(100, 180, 120)
		},
		GalaxyPurple = {
			-- Tema galáxia roxa
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(20, 5, 40)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(100, 30, 150)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 100, 200))
			}),
			["Color Hub 2"] = Color3.fromRGB(15, 8, 30),
			["Color Stroke"] = Color3.fromRGB(200, 80, 255),
			["Color Theme"] = Color3.fromRGB(180, 50, 255),
			["Color Text"] = Color3.fromRGB(255, 230, 255),
			["Color Dark Text"] = Color3.fromRGB(180, 140, 200)
		},
		FireStorm = {
			-- Tema fogo/laranja intenso
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(30, 10, 0)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(180, 50, 0)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 180, 0))
			}),
			["Color Hub 2"] = Color3.fromRGB(25, 12, 5),
			["Color Stroke"] = Color3.fromRGB(255, 120, 0),
		...
		IceBlue = {
			...
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(50, 120, 180)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(150, 220, 255))
			}),
			["Color Hub 2"] = Color3.fromRGB(12, 22, 35),
			["Color Stroke"] = Color3.fromRGB(100, 200, 255),
			["Color Theme"] = Color3.fromRGB(80, 180, 255),
			["Color Text"] = Color3.fromRGB(230, 245, 255),
			["Color Dark Text"] = Color3.fromRGB(150, 180, 210)
		},
		ToxicGreen = {
			-- Tema tóxico verde/amarelo
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(15, 20, 5)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(100, 150, 20)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(200, 255, 50))
			}),
			["Color Hub 2"] = Color3.fromRGB(18, 22, 8),
			["Color Stroke"] = Color3.fromRGB(180, 255, 60),
	...
	Info = {
		Version = "1.1.0 - Custom Themes"
	},
	Save = {
		UISize = {550, 380},
		TabSize = 160,
		Theme = "CyberNeon" -- Tema padrão mudado para CyberNeon
	},
	Settings = {},
	Connection = {},
	Instances = {},
